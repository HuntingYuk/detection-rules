...
# Exercises fast_pattern ("AWS_SECRET_ACCESS_KEY" IS present) but only as docs
# prose, with no = and no long secret value -> pcre rejects -> silent (§19 T6).
body=b"To deploy, set the AWS_SECRET_ACCESS_KEY environment variable to your IAM secret first."
reqh=b"GET /docs/setup HTTP/1.1\r\nHost: docs.example\r\nConnection: close\r\n\r\n"
resp=b"HTTP/1.1 200 OK\r\nContent-Type: text/html\r\nContent-Length: "+str(len(body)).encode()+b"\r\nConnection: close\r\n\r\n"+body
S="10.0.0.85";D="10.0.0.80";SP=51084
