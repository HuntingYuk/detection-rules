...
# Exercises fast_pattern (the phrase IS present) but as help-doc prose with no
# traceback frame (File "/line N/...Error:) after it -> pcre rejects -> silent.
body=(b"A page may show Traceback (most recent call last) text when DEBUG is on, "
      b"so always disable DEBUG before deploying to production environments.")
reqh=b"GET /help/debug HTTP/1.1\r\nHost: docs.example\r\nConnection: close\r\n\r\n"
resp=b"HTTP/1.1 200 OK\r\nContent-Type: text/html\r\nContent-Length: "+str(len(body)).encode()+b"\r\nConnection: close\r\n\r\n"+body
S="10.0.0.90";D="10.0.0.80";SP=51089
