...
# (CLAUDE.md §8). Send count+1 = 4 matching requests from one src.
uri=b"/search?q={{constructor.constructor('alert(document.domain)')()}}"
S="10.0.0.42";pkts=[];t=1_700_000_000.0
for i in range(4):
    s=44600+i
