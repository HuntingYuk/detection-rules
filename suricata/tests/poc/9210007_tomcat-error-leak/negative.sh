...
# Exercises fast_pattern ("Apache Tomcat/" IS present) but as docs prose with
# no error-frame markers -> pcre rejects -> silent (§19 T6).
body=(b"<html><body><p>To upgrade your Apache Tomcat/9 install to 10, follow the "
      b"migration guide; do not enable the default error report page in production.</p></body></html>")
reqh=b"GET /help/upgrade-tomcat HTTP/1.1\r\nHost: docs.example\r\nConnection: close\r\n\r\n"
resp=b"HTTP/1.1 200 OK\r\nContent-Type: text/html\r\nContent-Length: "+str(len(body)).encode()+b"\r\nConnection: close\r\n\r\n"+body
S="10.0.0.118";D="10.0.0.80";SP=51118
